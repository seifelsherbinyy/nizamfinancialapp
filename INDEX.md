...
- `docs/TELEGRAM_BOTS_SETUP_G3.md` — operator walkthrough for gate G3: create, harden and verify the two bots
- `docs/CLOUDFLARE_DNS_SETUP_G2.md` — operator walkthrough for gate G2: the two grey-cloud A records, and why proxied is wrong here
- `.kiro/specs/06-two-agent-vps/KIRO_SHIP_LIVE.prompt.md` — owner-authority task prompt: long-poll first release, the three-way mirror boundary, and the decisions ruled on 2026-08-10
- `.kiro/specs/06-two-agent-vps/TELEGRAM_VALUE_LEDGER.md` — transport value routing (G3 + G6): entry, file, secret flag, proof
